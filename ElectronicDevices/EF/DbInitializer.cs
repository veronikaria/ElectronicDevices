        ...
        private static void SeedDevices(ApplicationContext context)
        {
            context.Devices.AddRange(
                    new Device
                    {
                        ...
                        Kind = context.Kinds.FirstOrDefault(k=>k.Name.Equals("Smartphones")),
                        Price = 34000,
                        Stock = 15,
                    ...
                    new Device
                    {
                        ...
                        Kind = context.Kinds.FirstOrDefault(k=>k.Name.Equals("Laptops")),
                        Price = 43000,
                        Stock = 32,
                    ...
                    new Device
                    {
                        ...
                        Kind = context.Kinds.FirstOrDefault(k=>k.Name.Equals("TVs")),
                        Price = 20000,
                        Stock = 36,
